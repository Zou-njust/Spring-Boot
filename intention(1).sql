...
CREATE TABLE `t_gl_trackline`  (
  `id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '11' COMMENT '标识',
...
CREATE TABLE `t_yp_target_recog`  (
  `id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '11' COMMENT '研判结果id',
  `target_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '目标批号',
  `target_type` tinyint NULL DEFAULT NULL COMMENT '目标类别\r\n（0：ZC机\r\n1：Z斗机\r\n2：HZ机\r\n3：预警机\r\n4：民航\r\n255:其他）\r\n',
  ...
  `judge_means` tinyint NULL DEFAULT NULL COMMENT '研判手段（0：属性研判\r\n1：活动规律研判\r\n2：Z术Z法研判\r\n3：DC特征研判\r\n4：综合研判\r\n5：人工判证\r\n255：其他）\r\n',
  `probability` tinyint NULL DEFAULT NULL COMMENT '研判概率',
